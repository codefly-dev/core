...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CLI'].methods_by_name['GetDependenciesNetworkMappings']._loaded_options = None
  _globals['_CLI'].methods_by_name['GetDependenciesNetworkMappings']._serialized_options = b'\202\323\344\223\002=\022;/workspace/dependencies-network-mappings/{module}/{service}'
