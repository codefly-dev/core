...
// @generated from file proto/agents/communicate.proto (package v1.agents.communicate, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message v1.agents.communicate.Channel
 */
export class Channel extends Message$1<Channel> {
  ...
  static readonly typeName = "v1.agents.communicate.Channel";
...
/**
 * @generated from message v1.agents.communicate.Message
 */
export class Message extends Message$1<Message> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.Message";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.Display
 */
export class Display extends Message$1<Display> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.Display";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.Confirm
 */
export class Confirm extends Message$1<Confirm> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.Confirm";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.ConfirmAnswer
 */
export class ConfirmAnswer extends Message$1<ConfirmAnswer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.ConfirmAnswer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.Input
 */
export class Input extends Message$1<Input> {
  /**
   * @generated from oneof v1.agents.communicate.Input.default
   */
  default: {
    /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.Input";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.InputAnswer
 */
export class InputAnswer extends Message$1<InputAnswer> {
  /**
   * @generated from oneof v1.agents.communicate.InputAnswer.answer
   */
  answer: {
    /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.InputAnswer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.Choice
 */
export class Choice extends Message$1<Choice> {
  /**
   * @generated from field: repeated v1.agents.communicate.Message options = 1;
   */
  options: Message[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.Choice";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.ChoiceAnswer
 */
export class ChoiceAnswer extends Message$1<ChoiceAnswer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.ChoiceAnswer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.Selection
 */
export class Selection extends Message$1<Selection> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.Selection";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "options", kind: "message", T: Message, repeated: true },
  ]);
...
/**
 * @generated from message v1.agents.communicate.SelectionAnswer
 */
export class SelectionAnswer extends Message$1<SelectionAnswer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.SelectionAnswer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.Question
 */
export class Question extends Message$1<Question> {
  /**
   * @generated from field: v1.agents.communicate.Channel channel = 1;
   */
  channel?: Channel;
  ...
  /**
   * @generated from field: v1.agents.communicate.Message message = 3;
   */
  message?: Message;

  /**
   * @generated from oneof v1.agents.communicate.Question.value
   */
  value: {
    /**
     * @generated from field: v1.agents.communicate.Display display = 4;
     */
    value: Display;
    case: "display";
  } | {
    /**
     * @generated from field: v1.agents.communicate.Confirm confirm = 5;
     */
    value: Confirm;
    case: "confirm";
  } | {
    /**
     * @generated from field: v1.agents.communicate.Input input = 6;
     */
    value: Input;
    case: "input";
  } | {
    /**
     * @generated from field: v1.agents.communicate.Choice choice = 7;
     */
    value: Choice;
    case: "choice";
  } | {
    /**
     * @generated from field: v1.agents.communicate.Selection selection = 8;
     */
    value: Selection;
    case: "selection";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.Question";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.Answer
 */
export class Answer extends Message$1<Answer> {
  ...
  /**
   * @generated from field: v1.agents.communicate.Channel channel = 2;
   */
  channel?: Channel;
  ...
  /**
   * @generated from oneof v1.agents.communicate.Answer.value
   */
  value: {
    /**
     * @generated from field: v1.agents.communicate.ConfirmAnswer confirm = 5;
     */
    value: ConfirmAnswer;
    case: "confirm";
  } | {
    /**
     * @generated from field: v1.agents.communicate.InputAnswer input = 6;
     */
    value: InputAnswer;
    case: "input";
  } | {
    /**
     * @generated from field: v1.agents.communicate.ChoiceAnswer choice = 7;
     */
    value: ChoiceAnswer;
    case: "choice";
  } | {
    /**
     * @generated from field: v1.agents.communicate.SelectionAnswer selection = 8;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.Answer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message v1.agents.communicate.Engage
 */
export class Engage extends Message$1<Engage> {
  /**
   * @generated from field: v1.agents.communicate.Engage.Mode mode = 1;
   */
  mode = Engage_Mode.UNKNOWN;
  ...
  /**
   * @generated from field: v1.agents.communicate.Channel channel = 3;
   */
  channel?: Channel;

  /**
   * @generated from field: v1.agents.communicate.Answer answer = 4;
   */
  answer?: Answer;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.Engage";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "mode", kind: "enum", T: proto3.getEnumType(Engage_Mode) },
...
/**
 * @generated from enum v1.agents.communicate.Engage.Mode
 */
export enum Engage_Mode {
  /**
...
// Retrieve enum metadata with: proto3.getEnumType(Engage_Mode)
proto3.util.setEnumType(Engage_Mode, "v1.agents.communicate.Engage.Mode", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "START" },
  { no: 2, name: "END" },
]);
...
/**
 * @generated from message v1.agents.communicate.InformationRequest
 */
export class InformationRequest extends Message$1<InformationRequest> {
  /**
   * @generated from field: v1.agents.communicate.Question question = 1;
   */
  question?: Question;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.agents.communicate.InformationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
