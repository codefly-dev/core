...
const (
	...
	CLI_SessionHandshake_FullMethodName                         = "/codefly.cli.v0.CLI/SessionHandshake"
...
type CLIClient interface {
	...
	SessionHandshake(ctx context.Context, in *SessionHandshakeRequest, opts ...grpc.CallOption) (*SessionHandshakeResponse, error)
...
func (c *cLIClient) SessionHandshake(ctx context.Context, in *SessionHandshakeRequest, opts ...grpc.CallOption) (*SessionHandshakeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SessionHandshakeResponse)
	err := c.cc.Invoke(ctx, CLI_SessionHandshake_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CLIServer interface {
	...
	// session the caller started. It carries no HTTP annotation: session proofs
	// must not be reachable through the CLI's REST companion.
	SessionHandshake(context.Context, *SessionHandshakeRequest) (*SessionHandshakeResponse, error)
	// GetAgentInformation returns metadata and documentation for an installed agent.
...
func (UnimplementedCLIServer) SessionHandshake(context.Context, *SessionHandshakeRequest) (*SessionHandshakeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SessionHandshake not implemented")
}
...
func _CLI_SessionHandshake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SessionHandshakeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CLIServer).SessionHandshake(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CLI_SessionHandshake_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CLIServer).SessionHandshake(ctx, req.(*SessionHandshakeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CLI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SessionHandshake",
			Handler:    _CLI_SessionHandshake_Handler,
		},
		{
