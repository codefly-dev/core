...
// 	protoc        (unknown)
// source: observability/v1/sessions.proto
...
func (x *ProjectSnapshot) Reset() {
	*x = ProjectSnapshot{}
	if protoimpl.UnsafeEnabled {
		mi := &file_observability_v1_sessions_proto_msgTypes[0]
...
func (*ProjectSnapshot) Descriptor() ([]byte, []int) {
	return file_observability_v1_sessions_proto_rawDescGZIP(), []int{0}
}
...
func (x *ApplicationSnapshot) Reset() {
	*x = ApplicationSnapshot{}
	if protoimpl.UnsafeEnabled {
		mi := &file_observability_v1_sessions_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ApplicationSnapshot) Descriptor() ([]byte, []int) {
	return file_observability_v1_sessions_proto_rawDescGZIP(), []int{1}
}
...
func (x *PartialSnapshot) Reset() {
	*x = PartialSnapshot{}
	if protoimpl.UnsafeEnabled {
		mi := &file_observability_v1_sessions_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PartialSnapshot) Descriptor() ([]byte, []int) {
	return file_observability_v1_sessions_proto_rawDescGZIP(), []int{2}
}
...
func (x *Session) Reset() {
	*x = Session{}
	if protoimpl.UnsafeEnabled {
		mi := &file_observability_v1_sessions_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Session) Descriptor() ([]byte, []int) {
	return file_observability_v1_sessions_proto_rawDescGZIP(), []int{3}
}
...
var File_observability_v1_sessions_proto protoreflect.FileDescriptor

var file_observability_v1_sessions_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68,
	...
	0x65, 0x72, 0x76, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x70,
	...
	0x76, 0x31, 0x2e, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x6e,
	...
	0x42, 0xd1, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61,
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x31, 0x42, 0x0d, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x49, 0x67, 0x69, 0x74, 0x68,
...
var (
	file_observability_v1_sessions_proto_rawDescOnce sync.Once
	file_observability_v1_sessions_proto_rawDescData = file_observability_v1_sessions_proto_rawDesc
)

func file_observability_v1_sessions_proto_rawDescGZIP() []byte {
	file_observability_v1_sessions_proto_rawDescOnce.Do(func() {
		file_observability_v1_sessions_proto_rawDescData = protoimpl.X.CompressGZIP(file_observability_v1_sessions_proto_rawDescData)
	})
	return file_observability_v1_sessions_proto_rawDescData
}

var file_observability_v1_sessions_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_observability_v1_sessions_proto_goTypes = []interface{}{
	(*ProjectSnapshot)(nil),       // 0: observability.v1.ProjectSnapshot
	(*ApplicationSnapshot)(nil),   // 1: observability.v1.ApplicationSnapshot
	(*PartialSnapshot)(nil),       // 2: observability.v1.PartialSnapshot
	(*Session)(nil),               // 3: observability.v1.Session
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_observability_v1_sessions_proto_depIdxs = []int32{
	0, // 0: observability.v1.ApplicationSnapshot.project:type_name -> observability.v1.ProjectSnapshot
	0, // 1: observability.v1.PartialSnapshot.project:type_name -> observability.v1.ProjectSnapshot
	1, // 2: observability.v1.PartialSnapshot.applications:type_name -> observability.v1.ApplicationSnapshot
	4, // 3: observability.v1.Session.at:type_name -> google.protobuf.Timestamp
	2, // 4: observability.v1.Session.partial:type_name -> observability.v1.PartialSnapshot
	1, // 5: observability.v1.Session.application:type_name -> observability.v1.ApplicationSnapshot
...
func init() { file_observability_v1_sessions_proto_init() }
func file_observability_v1_sessions_proto_init() {
	if File_observability_v1_sessions_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_observability_v1_sessions_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_observability_v1_sessions_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_observability_v1_sessions_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_observability_v1_sessions_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_observability_v1_sessions_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*Session_Partial)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_observability_v1_sessions_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_observability_v1_sessions_proto_goTypes,
		DependencyIndexes: file_observability_v1_sessions_proto_depIdxs,
		MessageInfos:      file_observability_v1_sessions_proto_msgTypes,
	}.Build()
	File_observability_v1_sessions_proto = out.File
	file_observability_v1_sessions_proto_rawDesc = nil
	file_observability_v1_sessions_proto_goTypes = nil
	file_observability_v1_sessions_proto_depIdxs = nil
}
