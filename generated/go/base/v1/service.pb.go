...
var file_base_v1_service_proto_rawDesc = []byte{
	...
	0x31, 0x2f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb8, 0x01,
	...
	0x32, 0x0e, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x67, 0x65, 0x6e, 0x74,
	...
	0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x91, 0x01, 0x0a, 0x0b, 0x63, 0x6f,
...
var file_base_v1_service_proto_goTypes = []interface{}{
	...
	(*Agent)(nil),           // 3: base.v1.Agent
	(*Endpoint)(nil),        // 4: base.v1.Endpoint
}
var file_base_v1_service_proto_depIdxs = []int32{
	3, // 0: base.v1.Service.agent:type_name -> base.v1.Agent
	4, // 1: base.v1.Service.endpoints:type_name -> base.v1.Endpoint
