...
func (x *Deployment) GetKustomize() *KustomizeDeployment {
	if x, ok := x.GetKind().(*Deployment_Kustomize); ok {
		return x.Kustomize
	}
	return nil
}
...
type Deployment_Kustomize struct {
	Kustomize *KustomizeDeployment `protobuf:"bytes,2,opt,name=kustomize,proto3,oneof"`
}

func (*Deployment_Kustomize) isDeployment_Kind() {}
...
type KustomizeDeployment struct {
	...
	BuildContext *DockerBuildContext `protobuf:"bytes,1,opt,name=build_context,json=buildContext,proto3" json:"build_context,omitempty"`
...
func (x *KustomizeDeployment) GetBuildContext() *DockerBuildContext {
	if x != nil {
...
var file_services_builder_v0_deployment_proto_rawDesc = []byte{
	...
	0x2f, 0x64, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7c, 0x0a,
	0x0a, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x6e,
	0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x48, 0x0a, 0x09, 0x6b, 0x75, 0x73,
	0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x73,
	...
	0x69, 0x7a, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0x85, 0x01, 0x0a, 0x13,
	0x4b, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x12, 0x4c, 0x0a, 0x0d, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x63, 0x6f, 0x6e,
	...
	0x65, 0x78, 0x74, 0x52, 0x0c, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78,
	...
	0x69, 0x6f, 0x6e, 0x2a, 0x1f, 0x0a, 0x0e, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e,
	0x74, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x0d, 0x0a, 0x09, 0x4b, 0x55, 0x53, 0x54, 0x4f, 0x4d, 0x49,
	0x5a, 0x45, 0x10, 0x00, 0x42, 0xd6, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x2e, 0x76, 0x30,
	...
	,
...
var file_services_builder_v0_deployment_proto_goTypes = []interface{}{
	...
	(*DockerBuildContext)(nil),  // 3: services.builder.v0.DockerBuildContext
}
var file_services_builder_v0_deployment_proto_depIdxs = []int32{
	...
	3, // 1: services.builder.v0.KustomizeDeployment.build_context:type_name -> services.builder.v0.DockerBuildContext
