...
const (
	...
	Factory_Build_FullMethodName       = "/service.factory.v1.Factory/Build"
	Factory_Deploy_FullMethodName      = "/service.factory.v1.Factory/Deploy"
	Factory_Communicate_FullMethodName = "/service.factory.v1.Factory/Communicate"
)
...
func (c *factoryClient) Communicate(ctx context.Context, in *v1.Engage, opts ...grpc.CallOption) (*v1.InformationRequest, error) {
...
func (UnimplementedFactoryServer) Communicate(context.Context, *v1.Engage) (*v1.InformationRequest, error) {
...
func _Factory_Communicate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FactoryServer).Communicate(ctx, req.(*v1.Engage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Factory_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.factory.v1.Factory",
	...
	Metadata: "services/factory/v1/factory.proto",
}
