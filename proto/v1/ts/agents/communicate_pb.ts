...
// @generated from file agents/communicate.proto (package v1.agents.communicate, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum v1.agents.communicate.Method
 */
export enum Method {
  /**
...
proto3.util.setEnumType(Method, "v1.agents.communicate.Method", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "CREATE" },
  { no: 10, name: "SYNC" },
]);
...
export class Channel extends Message$1<Channel> {
  /**
   * @generated from field: v1.agents.communicate.Method method = 1;
   */
...
export class Answer extends Message$1<Answer> {
  ...
  /**
   * @generated from field: v1.agents.communicate.Method method = 2;
   */
  method = Method.UNKNOWN;
...
export class Engage extends Message$1<Engage> {
  ...
  /**
   * @generated from field: v1.agents.communicate.Answer answer = 2;
   */
  answer?: Answer;
...
export class InformationRequest extends Message$1<InformationRequest> {
  ...
  /**
   * @generated from field: v1.agents.communicate.Question question = 3;
   */
  question?: Question;
