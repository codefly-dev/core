...
// @generated from file plugins/logs.proto (package v1.plugins.logs, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message v1.plugins.logs.Log
 */
export class Log extends Message<Log> {
  ...
  /**
   * @generated from field: v1.plugins.logs.Log.Kind kind = 4;
   */
  ...
  static readonly typeName = "v1.plugins.logs.Log";
...
/**
 * @generated from enum v1.plugins.logs.Log.Kind
 */
...
proto3.util.setEnumType(Log_Kind, "v1.plugins.logs.Log.Kind", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "PLUGIN" },
  { no: 2, name: "SERVICE" },
]);
...
/**
 * @generated from message v1.plugins.logs.LogSessionGroup
 */
export class LogSessionGroup extends Message<LogSessionGroup> {
  ...
  /**
   * @generated from field: repeated v1.plugins.logs.Log logs = 2;
   */
  logs: Log[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "v1.plugins.logs.LogSessionGroup";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
