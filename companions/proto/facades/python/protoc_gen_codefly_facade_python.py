"""protoc plugin `protoc-gen-codefly-facade-python`.
...
_PLUGIN = "protoc-gen-codefly-facade-python"
...
def render(
    ...
    package_of_first = services[0][0]
    header = [
        f'"""Gateway-bound facade for the `{module}` module — generated, do not edit.',
        "",
        f"generated by {_PLUGIN} from {package_of_first}; do not edit",
