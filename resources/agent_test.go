...
func TestAgentCacheSeparatorCannotAppearInNameOrVersion(t *testing.T) {
	...
	for _, registration := range resources.AgentKindRegistry() {
		...
		for _, name := range []string{"widget", "widget_", "widget_1"} {
