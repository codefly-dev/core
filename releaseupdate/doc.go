...
// selects a GoReleaser-compatible OS/architecture asset, and persists HTTP
// validators and release metadata only through a caller-supplied Store.
//
...
// bounded before a verified executable can be staged. Apply uses atomic
// replacement with rollback through go-selfupdate.
//
